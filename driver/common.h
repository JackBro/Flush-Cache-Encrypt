...
//不支持符号链接用户相关性
#define DEVICE_NAME                  L"\\Device\\devIkeyRedirect"             // Driver Name
#define SYMBOLIC_LINK_NAME           L"\\DosDevices\\IkeyRedirect"            // Symbolic Link Name
#define WIN32_LINK_NAME              "\\\\.\\IkeyRedirect"                    // Win32 Link Name

//支持符号链接用户相关性
#define SYMBOLIC_LINK_GLOBAL_NAME    L"\\DosDevices\\Global\\IkeyRedirect"    // Symbolic Link Name
