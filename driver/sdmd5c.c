...
unsigned char digest[MD5_HASH_SIZE];                  /* message digest */
...
NTSTATUS	DriverEntry(PDRIVER_OBJECT	pDriverObject, PUNICODE_STRING	puniRegistry)
{
...
//		CloseHandle(hFile);
		...
		MD5Update(&md5, szBuffer, dwLength); 
