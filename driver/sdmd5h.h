...
#ifndef __SD_MD5H_H__
#define __SD_MD5H_H__
#include <string.h>
...
extern "C" {
	...
	void MD5Init(void *);
	void MD5Update(void *, unsigned char *, unsigned long);
	void MD5Final(unsigned char [MD5_HASH_SIZE], void *);

/*	void MD5HMAC(unsigned char *key, unsigned long keylen,
